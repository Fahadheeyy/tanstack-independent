...
//#endregion
export { Content2, Header, Item, Presence, Primitive, Root2, Trigger2, createContextScope, createSlot, dispatchDiscreteCustomEvent, require_jsx_runtime, require_react, require_react_dom, useComposedRefs, useControllableState, useId, useLayoutEffect2 };
