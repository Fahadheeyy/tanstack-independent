...
import { Presence, Primitive, createContextScope, createSlot, dispatchDiscreteCustomEvent, require_jsx_runtime, require_react, require_react_dom, useComposedRefs, useControllableState, useId, useLayoutEffect2 } from "./react-accordion+[...].mjs";
