...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D2YnCjAo.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-tFuczygs.css";
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "India's premium travel community for Gen Z & Millennials. Weekly curated group departures. Small groups, verified captains, unforgettable memories."
			},
			{
...
var $$splitComponentImporter = () => import("./routes-Ji9GhIZV.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "India's premium travel community for Gen Z & Millennials. Weekly group departures to Goa, Spiti, Kashmir, Manali, Udaipur and more. Small groups, verified captains, curated stays."
			},
			{
				property: "og:title",
				content: "TripBaaz — Travel with strangers. Leave with family."
			},
			{
			...
			{
				name: "twitter:title",
				content: "TripBaaz — India's premium travel community"
			},
			{
