...
import { createMiddleware } from "./createMiddleware-DSe8_z3G.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C9fJ_hTQ.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D2YnCjAo.mjs"),
		import("./start-Inc1nmp1.mjs"),
